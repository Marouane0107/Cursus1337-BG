...
/*   Updated: 2024/01/26 00:56:03 by maouzal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_animated_textures_init(t_mlx *mlx)
{
	...
	mlx->animation = 0;
	i = 0;
	mlx->animated_texture[0] = "textres/door00.xpm";
	mlx->animated_texture[1] = "textres/door01.xpm";
	mlx->animated_texture[2] = "textres/door00.xpm";
	mlx->animated_texture[3] = "textres/door03.xpm";
